(function (b, a) {
    ...
    c.fn = c.prototype = {
        constructor: c, ind: 0, prev: function (g, f, e, d) {
            if (g.type == "fade") {
                ...
                if (g.type == "updown") {
                    ...
                    if (this.ind == 0) {
                        f.eq(d - 1).css("top", "-100%").show().animate({"top": 0}, 300)
                    } else {
                        f.eq(this.ind).prev().css("top", "-100%").show().animate({"top": 0}, 300)
                    }
                    this.ind--;
                    if (this.ind < 0) {
                        this.ind = d - 1
                    ...
                    if (g.type == "leftright" || g.type == undefined) {
                        ...
                        if (this.ind == 0) {
                            f.eq(d - 1).css("left", "-100%").show().animate({"left": 0}, 300)
                        } else {
                            f.eq(this.ind).prev().css("left", "-100%").show().animate({"left": 0}, 300)
                        }
                        this.ind--;
                        if (this.ind < 0) {
                            this.ind = d - 1
            ...
            if (g.type == "fade") {
                ...
                if (g.type == "updown") {
                    f.eq(this.ind).animate({"top": "-100%"}, 300);
                    if (this.ind == d - 1) {
                        f.eq(0).css("top", "100%").show().animate({"top": 0}, 300)
                    }
                    ...
                    if (g.type == "leftright" || g.type == undefined) {
                        f.eq(this.ind).animate({"left": "-100%"}, 300);
                        if (this.ind == d - 1) {
                            f.eq(0).css("left", "100%").show().animate({"left": 0}, 300)
                        }
            ...
            var h = this, d = f.children(".pb-carousel").children().length, g = f.children(".pb-carousel").children(),
            ...
            var j = this, g = k.time || 3000, d = f.children(".pb-carousel").children().length,
                i = f.children(".pb-carousel").children(), e = f.children(".pb-carousel-ind").children(),
